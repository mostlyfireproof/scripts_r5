...
void function MakeScoreRUI()
{
    ...
    var screenAlignmentTopo = RuiTopology_CreatePlane( <(screenSize.width * -0.1),( screenSize.height * -0.5 ), 0>, <float( screenSize.width ), 0, 0>, <0, float( screenSize.height ), 0>, false )
