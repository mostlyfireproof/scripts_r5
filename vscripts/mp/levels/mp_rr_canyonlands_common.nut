...
#if SERVER
// Just creates a wall at a vector
...
// Given a size and start coordinates, creates a grid 
...
// Creates a button
entity function CreateButton(vector pos, vector ang, string prompt)
{
...
// Creates a bubble to represent a pixel and animates it
entity function CreatePixel( vector pos, string colors )
{
	...
	bubbleShield.kv.fadedist = 10000
    bubbleShield.kv.CollisionGroup = 0

	bubbleShield.Highlight_ShowInside( 1.0 )
	bubbleShield.Highlight_ShowOutline( 0.0 )
    bubbleShield.Highlight_SetFunctions( 0, 101, true, 101, 8.0, 2, false )
	bubbleShield.Highlight_SetParam( 0, 1, <fillIntensityScalar, outlineIntensityScalar, 0> )
